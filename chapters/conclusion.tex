...
Its performance is quite good, which is important in \textit{Cloud Computing}, which aims to deliver computational power on demand.\rp{try to reduce amounts of which.}
