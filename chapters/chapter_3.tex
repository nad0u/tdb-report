...
It returns the performance in the number of transactions per minute C (tpmC) \rp{what is C?}, which corresponds to the average number of new orders the system is processing per minute.
