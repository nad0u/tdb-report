...
To be sure that this is not just a "bad luck" during the benchmark, more runs can be done.
...
As the process of filling the databases is very long (especially with greater scale factors), snapshots of the virtual machine are taken.
...
Both virtual machines are created with \textit{large} flavor and have a volume attached to them. 
