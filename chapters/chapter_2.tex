...
%%--------------- subsubsection
\subsection{Machines}
This section will present the hardware used for the experiments. We have three physical machines on which OpenStack services are installed, and several virtual machines with different flavors will be created on the physical machines with OpenStack.


\paragraph{Physical machines}\mbox{}\\
The three physical machines mentionned in Section \ref{section_setup} are HP Compaq Elite 8300 SFF with a 64-bit architecture. 
