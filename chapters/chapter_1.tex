...
% Then with the help of \textit{Juju}\footnote{\url{https://jujucharms.com}}\rp{add footnote + small descriptions, you need to introduce it to an unprepared reader} it is easier to deploy a IaaS like OpenStack on the hardware.
